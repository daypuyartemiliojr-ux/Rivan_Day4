...
conf t
 ...
 int g3
  ...
  exit
 int g4
  ip add 10.15.1.11 255.255.255.0
  no shut
  exit
 !
...
ifname ens256 \
ipv4.method manual \
ipv4.addresses 10.15.1.6/24 \
autoconnect yes

nmcli connection up BRIDGED


ip route add 10.0.0.0/8 via 10.15.1.4 dev ens256
ip route add 200.0.0.0/24 via 10.15.1.4 dev ens256
...
__Make Sure EDGE-15 is Configured__
...
conf t
 ...
 int gi 0/0/0
  no shut
  ip add 10.15.15.1 255.255.255.0
  desc INSIDE
 int gi 0/0/1
  no shut
  ip add 200.0.0.15 255.255.255.0
  desc OUTSIDE
 int loopback 0
  ip add 15.0.0.1 255.255.255.255
  desc VIRTUALIP
  exit
...
conf t
 ...
 int gi 0/1
  no shut
  no switchport
  ip add 10.15.15.4 255.255.255.0
 int vlan 1
  no shut
  ip add 10.15.1.4 255.255.255.0
  desc DEFAULT-VLAN
 int vlan 10
  no shut
  ip add 10.15.10.4 255.255.255.0
  desc WIFI-VLAN
 int vlan 50
  no shut
  ip add 10.15.50.4 255.255.255.0
  desc CCTV-VLAN
 int vlan 100
  no shut
  ip add 10.15.100.4 255.255.255.0
  desc VOICE-VLAN
  exit
 !
 vlan 10
...
conf t
 ...
 int fa 0/0
  no shut
  ip add 10.15.100.8 255.255.255.0
  exit
 ip routing
 router ospf 1
  router-id 10.15.100.8
...
!@UTM-PH
conf t
 ip route 10.0.0.0 255.0.0.0 10.15.1.4
 ip route 200.0.0.0 255.255.255.0 10.15.1.4
 end
~~~
...
### Task 1: Prevent traffic only from VLAN 100 (CUCM) to reach UTM-PH (10.15.1.11)
~~~
!@UTM-PH
config t
...
### Task 2: Prevent traffic coming from the PC (10.15.1.10) and the EDGE Router from reaching UTM-PH (10.15.1.11)
~~~
!@UTM-PH
config t
...
### Task 3: Allow the PC (10.15.1.10) to access HTTP, SSH, and ICMP of UTM-PH (10.15.1.11)
...
!@UTM-PH
config t
 ip host www.bet11.com 10.15.1.11
 service finger
 ...
 telephony-service
  ...
  max-ephones 5
  max-dn 20
  ip source-address 10.15.1.11 port 2000
  exit
 voice service voip
 ...
 voice register global
  mode cme
  source-address 10.15.1.11 port 5060
  max-dn 12
  max-pool 12
...
- Allow Pings destined for your PC (10.15.1.10)  
...
config t
 ip access-list extended FWP5
  permit  icmp  any  host 10.15.1.10             log 
...
| SERVER      | INSIDE PORT | OUTSIDE IP     | OUTSIDE PORT |
| ---         | ---         | ---            | ---          |
| CoreTAAS    | 23          | 200.0.0.15 | 2023         |
| CoreBABA    | 23          | 200.0.0.15 | 4023         |
| CUCM        | 23          | 200.0.0.15 | 8020         |
...
!@EDGE-15
conf t
 ip nat inside source static tcp  10.15.1.4  23  200.0.0.15  4023
 !
 ip nat inside source static tcp  10.15.1.4  __  __.__.__.__     __
 ip nat inside source static tcp  10.15.1.4  __  __.__.__.__     __
 end
~~~
...
!@EDGE-15
conf t
 ip nat inside source static tcp  10.15.1.11  6969  200.0.0.15  3306
 end
~~~
...
conf t
 ...
 ip access-list extended NAT-POLICY
  deny ip 10.15.0.0 0.0.255.255 10.11.0.0 0.0.255.255
  deny ip 10.15.0.0 0.0.255.255 10.12.0.0 0.0.255.255
  deny ip 10.15.0.0 0.0.255.255 10.21.0.0 0.0.255.255
  deny ip 10.15.0.0 0.0.255.255 10.22.0.0 0.0.255.255
  deny ip 10.15.0.0 0.0.255.255 10.31.0.0 0.0.255.255
  deny ip 10.15.0.0 0.0.255.255 10.32.0.0 0.0.255.255
  deny ip 10.15.0.0 0.0.255.255 10.41.0.0 0.0.255.255
  deny ip 10.15.0.0 0.0.255.255 10.42.0.0 0.0.255.255
  deny ip 10.15.0.0 0.0.255.255 10.51.0.0 0.0.255.255
  deny ip 10.15.0.0 0.0.255.255 10.52.0.0 0.0.255.255
  deny ip 10.15.0.0 0.0.255.255 10.61.0.0 0.0.255.255
  deny ip 10.15.0.0 0.0.255.255 10.62.0.0 0.0.255.255
  deny ip 10.15.0.0 0.0.255.255 10.71.0.0 0.0.255.255
  deny ip 10.15.0.0 0.0.255.255 10.72.0.0 0.0.255.255
  deny ip 10.15.0.0 0.0.255.255 10.81.0.0 0.0.255.255
  deny ip 10.15.0.0 0.0.255.255 10.82.0.0 0.0.255.255
  deny ip 10.15.0.0 0.0.255.255 10.91.0.0 0.0.255.255
  deny ip 10.15.0.0 0.0.255.255 10.92.0.0 0.0.255.255
  no deny ip 10.15.0.0 0.0.255.255 10.15.0.0 0.0.255.255
  permit ip any any
  end
~~~
...
conf t
 int tun1
  ip add 172.16.1.15 255.255.255.0
  ...
  no ip nhrp map 172.16.1.15 200.0.0.15
  exit
 !
 !
 ...
 !
 no ip route 10.15.0.0 255.255.0.0 172.16.1.15 252
 end
~~~
